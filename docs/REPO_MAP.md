...
| `docs/` | Human-facing docs: `Roadmap.md` (RENDERED view — never hand-edit, see update-roadmap skill), `engineering-plans/`, `go-to-market-plans/`, `branding/identity.md`, `branding/DESIGN_SYSTEM.md` (canonical visual+brand tokens — ads/slides/creatives read this), this map. |
